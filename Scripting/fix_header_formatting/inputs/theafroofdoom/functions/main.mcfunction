...
# Reset scores
execute unless entity @a[team=tutorial_adv] run scoreboard players set #global.room.tutorial.advanced.occupied setting 0
execute unless entity @a[team=tutorial_adv] unless block 55 121 -152 air run setblock 55 121 -152 air
execute unless entity @a[team=tutorial_basic] run scoreboard players set #global.room.tutorial.basic.occupied setting 0
execute unless entity @a[team=tutorial_basic] unless block 55 121 -168 air run setblock 55 121 -168 air
