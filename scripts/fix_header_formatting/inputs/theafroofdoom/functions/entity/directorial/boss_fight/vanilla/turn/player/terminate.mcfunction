...
execute unless entity @e[tag=jevil_hitbox] run function theafroofdoom:entity/directorial/boss_fight/vanilla/terminate/death

# If Jevil has been pacified, summon and initialize Jevil-pacified cutscene director
execute if entity @e[tag=jevil_hitbox] if score @s bfight_pacified matches 1.. run function theafroofdoom:entity/directorial/boss_fight/vanilla/terminate/pacified
