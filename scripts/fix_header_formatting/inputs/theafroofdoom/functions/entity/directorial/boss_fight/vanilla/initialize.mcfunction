...
# Add Tag
tag @s add boss_fight_active

# Set scores
scoreboard players set @s bfight_clock -1
...
# REVIEW(jordan): Make sure bfight_tired_phs feels right for the amount of players.
...
#
# bfight_tired_phs = (4 + (difficulty - 2)) + (4 * (number_of_players - 1))
#                  = difficulty + (4 * player_count) - 2
scoreboard players set @s bfight_tired_phs 4
execute store result score @s afro.math_1 run difficulty
scoreboard players remove @s afro.math_1 2
scoreboard players operation @s bfight_tired_phs += @s afro.math_1
scoreboard players operation @s afro.math_1 = #settings.player_count setting
scoreboard players remove @s afro.math_1 1
scoreboard players operation @s afro.math_1 *= #4 constant
scoreboard players operation @s bfight_tired_phs += @s afro.math_1

# REVIEW(jordan): Make sure bfight_tired feels right for the amount of players.
