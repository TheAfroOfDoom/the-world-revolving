...
execute if score #settings.text.location setting matches 1 run title @a actionbar [{"bold": "true", "translate": "jevil.speak.phase.4.0.1", "with": [{"bold": "true", "selector": "@e[tag=jevil]"}, {"bold": "true", "color": "green", "text": ":"}]}]
