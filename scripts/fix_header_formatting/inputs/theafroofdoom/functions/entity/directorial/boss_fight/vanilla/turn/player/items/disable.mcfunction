...
# Function: \entity\directorial\boss_fight\vanilla\turn\player\items\disable.mcfunction
...
execute positioned -30000000 0 1602 run function theafroofdoom:entity/directorial/boss_fight/vanilla/turn/player/items/disable_helper
...
effect give @s weakness 100000 100 true
