...
# Function: \entity\player\team\tutorial\advanced\fix_inventory\give\quit\health.mcfunction
...
execute unless data entity @s {Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:8b,tag:{CustomModelData:14}}]} if data entity @s {Inventory:[{Slot:8b}]} run function theafroofdoom:entity/player/team/tutorial/advanced/fix_inventory/give/quit_fix
