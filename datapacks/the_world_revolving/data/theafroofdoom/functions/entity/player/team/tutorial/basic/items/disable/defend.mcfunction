...
# Function: \entity\player\team\tutorial\basic\items\disable\defend.mcfunction
...
execute positioned -30000000 0 1602 run function theafroofdoom:entity/player/team/tutorial/basic/items/disable/defend_helper
