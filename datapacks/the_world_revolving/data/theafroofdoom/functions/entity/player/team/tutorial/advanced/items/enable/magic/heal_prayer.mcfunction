...
# Function: \entity\player\team\tutorial\advanced\items\enable\magic\heal_prayer.mcfunction
...
execute positioned -30000000 0 1602 run function theafroofdoom:entity/player/team/tutorial/advanced/items/enable/magic/heal_prayer_helper
