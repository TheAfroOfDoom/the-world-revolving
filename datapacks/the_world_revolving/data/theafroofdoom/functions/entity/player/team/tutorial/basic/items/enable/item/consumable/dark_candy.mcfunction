...
# Function: \entity\player\team\tutorial\basic\items\enable\item\consumable\dark_candy.mcfunction
...
execute positioned -30000000 0 1602 run function theafroofdoom:entity/player/team/tutorial/basic/items/enable/item/consumable/dark_candy_helper
