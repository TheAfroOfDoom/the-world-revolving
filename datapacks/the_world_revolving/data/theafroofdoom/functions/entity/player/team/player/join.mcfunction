...
# Function: \entity\player\team\player\join.mcfunction
...
execute unless score @s player_spam >= #settings.spam setting run function theafroofdoom:entity/player/team/player/join_helper
