...
# Function: \entity\player\team\tutorial\advanced\fix_inventory\give\quit\quit.mcfunction
...
execute unless data entity @s {Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:8b,tag:{CustomModelData:15}}]} if data entity @s {Inventory:[{Slot:8b}]} run function theafroofdoom:entity/player/team/tutorial/advanced/fix_inventory/give/quit_fix
