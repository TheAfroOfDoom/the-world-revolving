...
# Function: \entity\player\team\tutorial\basic\items\enable\magic\pacify.mcfunction
...
execute positioned -30000000 0 1602 run function theafroofdoom:entity/player/team/tutorial/basic/items/enable/magic/pacify_helper
