...
# Function: \entity\player\team\tutorial\basic\fix_inventory\give\quit_fix\offhand.mcfunction

# Load offhand
function phi.modifyinv:load/offhand

# Store item data in temporary entity
summon item ~ ~ ~ {Age:6000,Item:{Count:1,id:"minecraft:stone"},PickupDelay:32767,Tags:["the_world_revolving","directorial","tutorial_prop","tutorial_prop_basic","quit_fix_offhand","quit_fix_offhand_basic"]}
