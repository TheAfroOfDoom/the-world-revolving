...
# Function: \entity\player\team\tutorial\advanced\items\disable\selected\skip.mcfunction
...
execute positioned -30000000 0 1602 run function theafroofdoom:entity/player/team/tutorial/advanced/items/disable/selected/skip_helper
