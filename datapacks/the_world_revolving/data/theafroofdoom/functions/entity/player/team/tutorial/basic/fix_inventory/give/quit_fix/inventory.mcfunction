...
# Function: \entity\player\team\tutorial\basic\fix_inventory\give\quit_fix\inventory.mcfunction

# Load inventory
function phi.modifyinv:load/inventory

# Store item data in temporary entity
summon item ~ ~ ~ {Age:6000,Item:{Count:1,id:"minecraft:stone"},PickupDelay:32767,Tags:["the_world_revolving","directorial","tutorial_prop","tutorial_prop_basic","quit_fix_inventory","quit_fix_inventory_basic"]}
