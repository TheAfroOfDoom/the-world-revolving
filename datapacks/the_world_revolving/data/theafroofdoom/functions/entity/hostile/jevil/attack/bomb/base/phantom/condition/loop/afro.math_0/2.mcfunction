...
# Function: \entity\hostile\jevil\attack\bomb\base\phantom\condition\loop\afro.math_0\2.mcfunction

# Descend
teleport @s ~ ~-2.148148148 ~

# Update future height score
scoreboard players remove @s afro.math_1 215
