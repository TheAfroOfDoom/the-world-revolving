...
# Function: \entity\hostile\jevil\attack\devilsknife\basic\indicator\summon_bullets.mcfunction
...
# Set model score
scoreboard players operation @e[tag=attack_bullet_devilsknife_new] attack_model = #attack_devilsknife_basic attack_model

# Set attack_variant score
scoreboard players set @e[tag=attack_bullet_devilsknife_new] attack_variant -2
