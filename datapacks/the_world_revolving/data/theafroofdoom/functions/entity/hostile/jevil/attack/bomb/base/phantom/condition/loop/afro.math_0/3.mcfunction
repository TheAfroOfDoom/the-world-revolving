...
# Function: \entity\hostile\jevil\attack\bomb\base\phantom\condition\loop\afro.math_0\3.mcfunction

# Descend
teleport @s ~ ~-2.557319224 ~

# Update future height score
scoreboard players remove @s afro.math_1 256
