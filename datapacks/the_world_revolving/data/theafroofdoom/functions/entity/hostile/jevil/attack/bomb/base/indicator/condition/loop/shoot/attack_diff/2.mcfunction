...
# Function: \entity\hostile\jevil\attack\bomb\base\indicator\condition\loop\shoot\attack_diff\2.mcfunction
...
# Set bullets scores
scoreboard players set @e[scores={group_id=0},tag=attack_bullet_bomb_inactive] attack_clock -1
