...
# Set model score
scoreboard players operation @e[tag=attack_bullet_red_devilsknife_new] attack_model = #attack_devilsknife_basic attack_model_1

# Set attack_variant score
scoreboard players set @e[tag=attack_bullet_red_devilsknife_new] attack_variant -2
