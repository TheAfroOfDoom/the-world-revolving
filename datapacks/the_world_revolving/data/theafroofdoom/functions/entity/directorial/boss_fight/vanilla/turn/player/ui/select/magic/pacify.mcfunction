...
# Playsounds
execute at @e[tag=jevil] run playsound theafroofdoom:player.do.magic.pacify player @a[tag=player_room_boss_fight_vanilla] ~ ~ ~ 15 1 0.5
execute positioned ~ ~ ~-135 run playsound theafroofdoom:player.do.magic.pacify player @a[tag=player_room_boss_fight_vanilla] ~ ~ ~ 15 1 0.5
