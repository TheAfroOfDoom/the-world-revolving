...
execute if score #settings.text.location setting matches 1 run title @a[tag=player_room_boss_fight_vanilla] actionbar [{"bold": "true", "translate": "jevil.speak.phase.3.1", "with": [{"bold": "true", "selector": "@e[tag=jevil]"}, {"bold": "true", "color": "green", "text": ":"}]}]
