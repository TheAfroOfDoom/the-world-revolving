...
# Function: \entity\directorial\boss_fight\vanilla\turn\player\ui\highlight\disable.mcfunction
...
execute positioned -30000000 0 1602 run function theafroofdoom:entity/directorial/boss_fight/vanilla/turn/player/ui/highlight/disable_helper/hotbar
...
execute positioned -30000000 0 1602 run function theafroofdoom:entity/directorial/boss_fight/vanilla/turn/player/ui/highlight/disable_helper
