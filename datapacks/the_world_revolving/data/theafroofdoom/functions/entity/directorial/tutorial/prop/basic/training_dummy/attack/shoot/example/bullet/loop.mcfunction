...
# Function: \entity\directorial\tutorial\prop\basic\training_dummy\attack\shoot\example\bullet\loop.mcfunction
...
execute if score @s afro.math_0 matches -1727.. run function theafroofdoom:entity/directorial/tutorial/prop/basic/training_dummy/attack/shoot/example/bullet/terminate
