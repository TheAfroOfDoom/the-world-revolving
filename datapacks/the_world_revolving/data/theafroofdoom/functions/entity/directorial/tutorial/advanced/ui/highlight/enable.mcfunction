...
# Function: \entity\directorial\tutorial\advanced\ui\highlight\enable.mcfunction
...
execute positioned -30000000 0 1602 run function theafroofdoom:entity/directorial/tutorial/advanced/ui/highlight/enable_helper
