...
# Function: \entity\directorial\tutorial\prop\advanced\training_dummy\attack\shoot\base\terminate.mcfunction

# Terminates entities tagged "training_dummy_is_attacking_shoot"

# Kill associated entities
kill @e[tag=prop_attack,tag=tutorial_prop_advanced]
