...
# Function: \entity\directorial\tutorial\advanced\items\disable.mcfunction
...
execute positioned -30000000 0 1602 run function theafroofdoom:entity/directorial/tutorial/advanced/items/disable_helper
