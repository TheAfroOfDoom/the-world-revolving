...
# Function: \entity\directorial\tutorial\basic\items\disable\attack.mcfunction
...
execute positioned -30000000 0 1602 run function theafroofdoom:entity/directorial/tutorial/basic/items/disable/attack_helper
