...
# Function: \entity\directorial\cutscene\pacified\vanilla\initialize.mcfunction
...
execute as @e[tag=lobby_jevil] at @s run function theafroofdoom:entity/directorial/cutscene/prop/pacified/vanilla/lobby_jevil/initialize
