...
# Function: \entity\directorial\cutscene\prop\pacified\vanilla\lobby_jevil\loop.mcfunction
...
execute at @s run function theafroofdoom:entity/directorial/cutscene/prop/pacified/vanilla/lobby_jevil/animate
